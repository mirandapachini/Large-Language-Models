...
QUESTIONS = [
    ...
    {
        "question": "What is Vector Space Dimension?",
        "keywords": ["Vector", "Space", "Dimension"],
    },
    {
        "question": "How does a businessman think about NLP?",
        "keywords": ["Businessman", "think", "NLP"],
    },
    {
